...
import com.fisc.decltca.DecltcaApp;
...
@SpringBootTest(classes = DecltcaApp.class)
@DirtiesContext(classMode = DirtiesContext.ClassMode.BEFORE_CLASS)
public class DecltcaKafkaResourceIT {
    ...
    @Autowired
    private DecltcaKafkaProducer producer;

    @Autowired
    private DecltcaKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        DecltcaKafkaResource kafkaResource = new DecltcaKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/decltca-kafka/publish?message=test"))
